...
public class ClusterMetrics {
  ...
  @Inject
  public ClusterMetrics(MasterServices master) {
  ...
  @GET
  @Path("/")
  public org.apache.hadoop.hbase.master.http.api_v1.cluster_metrics.model.ClusterMetrics
    getBaseMetrics() throws ExecutionException, InterruptedException {
    ...
    return org.apache.hadoop.hbase.master.http.api_v1.cluster_metrics.model.ClusterMetrics
      .from(get(fields));
  }
