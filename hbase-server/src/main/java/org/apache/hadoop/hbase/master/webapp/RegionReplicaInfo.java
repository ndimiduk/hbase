...
public final class RegionReplicaInfo {
  ...
  public boolean equals(Object other) {
    ...
    return new EqualsBuilder()
      ...
      .append(startKey, that.startKey)
      .append(endKey, that.endKey)
  ...
  @Override public String toString() {
    return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE)
      ...
      .append("regionName", Bytes.toStringBinary(regionName))
      .append("startKey", Bytes.toStringBinary(startKey))
      .append("endKey", Bytes.toStringBinary(endKey))
